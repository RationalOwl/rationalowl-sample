...
extension UIViewController {
    func showToast(_ message : String) {
        ...
        let toastLabel = UILabel(frame: CGRect(x: (self.view.frame.size.width - size.width) / 2, y: self.view.frame.size.height - 100, width: size.width + 16, height: size.height + 16))
