 ...
 * @param resultMsg 결과 코드인 resultCode에 대한 설명이다.
 * @param umi
 *      - (UpstreamMessageId) MinervaManager.sendUpstreamMsg() API 반환값과 동일한 값으로 이 콜백이 어느 API의 결과인지를 알려준다.
 */
 ...
 * @param resultMsg 결과 코드인 resultCode에 대한 설명이다.
 * @param pmi
 *        - (P2PMessageId) MinervaManager.sendP2PMsg() API 반환값과 동일한 값으로 이 콜백이 어느 API의 결과인지를 알려준다.
 */
